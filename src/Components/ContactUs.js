...
function ContactUs() {
    return (
        <div style={{ backgroundColor: "#131313", color: "white" }} className="d-flex flex-column px-5 py-4 justify-content-around">
            <div className="d-flex px-5 py-4 justify-content-around">
                <div className='col-lg-4 p-5'>
                    ...
                    <button className='btn btn-light border border-dark p-2' style={{ backgroundColor: "#FF6584", color: 'white' }} >Adopt <AiOutlineArrowRight /></button>
                </div>
                <div className='col-lg-4 p-5'>
            ...
            <div className='d-flex border-top py-3'>
                <div style={{ 'font-size': '14px', color: '#9CA3AF' }} className='col-lg-8'>
